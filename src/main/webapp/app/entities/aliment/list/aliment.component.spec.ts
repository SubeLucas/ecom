...
import { sampleWithRequiredData } from '../aliment.test-samples';
...
describe('Aliment Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aliments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to alimentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAlimentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAlimentIdentifier).toHaveBeenCalledWith(entity);
