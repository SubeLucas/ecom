...
import { sampleWithRequiredData } from '../client-order.test-samples';
...
describe('ClientOrder Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ClientOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientOrders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to clientOrderService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClientOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getClientOrderIdentifier).toHaveBeenCalledWith(entity);
